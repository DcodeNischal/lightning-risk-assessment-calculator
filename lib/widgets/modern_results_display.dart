          ...
          _buildSectionCard(
            ...
            [
              _buildDataRow('Total Cost of Structure', 'Ctotal',
                  '${widget.riskResult.totalCostOfStructure.toStringAsFixed(2)} million NPR'),
              const Divider(),
              _buildDataRow('CL - Cost of Loss Before Protection', 'CL',
                  '${widget.riskResult.costOfLossBeforeProtection.toStringAsFixed(4)} million NPR'),
              _buildDataRow('CRL - Cost of Loss After Protection', 'CRL',
                  '${widget.riskResult.costOfLossAfterProtection.toStringAsFixed(4)} million NPR'),
              _buildDataRow('CPM - Annual Cost of Protection Measures', 'CPM',
                  '${widget.riskResult.annualCostOfProtection.toStringAsFixed(4)} million NPR'),
              const Divider(),
              _buildDataRow('SM - Annual Savings (CL - CPM - CRL)', 'SM',
                  '${widget.riskResult.annualSavings.toStringAsFixed(4)} million NPR'),
              const Divider(),
